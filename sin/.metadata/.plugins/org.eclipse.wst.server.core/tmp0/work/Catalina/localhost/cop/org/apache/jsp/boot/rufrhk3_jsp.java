 ...
 * Generated at: 2019-11-07 07:46:53 UTC
...
public final class rufrhk3_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<body>\r\n");
      out.write("    <form method=\"post\" action=\"*\" id=\"aspnetForm\">\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t<h3 class=\"tit\">추천카페</h3>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      ...
      out.write("                    <img id=\"ctl00_Contents_imgMenu\" src=\"../boot/tkdvna_img/rodls.jpg\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"prdSummary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"summInner\">\r\n");
      out.write("\t\t\t\t\t\t<strong class=\"detailTit\">개인의 취향</strong>\r\n");
      out.write("\t\t\t\t\t\t<p class=\"menuTxt\">\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 시카고카페 -->\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<strong class=\"detailTit type02\">카페정보</strong>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"viewWrap type02\">\r\n");
      out.write("\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">주소</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t경남 창원시 마산회원구 내서읍 삼계6길 8\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">전화번호</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t1234-5678-9101\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">평점</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">추천 커피</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t1. 버블티<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t2. 레몬에이드<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t3. 고구마라떼<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t4. 밀크티\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <li>\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<br>\r\n");
      out.write("\t\t\t<h3 class=\"tit\">추천커피</h3>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t<span class=\"price\"></span>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t<div class=\"prdDetailWrap\">\r\n");
      out.write("\t\t\t\t<div class=\"prdImg\">\r\n");
      out.write("                    <img id=\"ctl00_Contents_imgMenu\" src=\"../boot/tkdvna_img/topinutte.png\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"prdSummary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"summInner\">\r\n");
      out.write("\t\t\t\t\t\t<strong class=\"detailTit\">토피넛라떼</strong>\r\n");
      out.write("\t\t\t\t\t\t<p class=\"menuTxt\">\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 아메리카노 -->\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<strong class=\"detailTit type02\">음료정보</strong>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"viewWrap type02\">\r\n");
      out.write("\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<br>\r\n");
      out.write("\t\t\t<h3 class=\"tit\">추천원두</h3>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t<span class=\"price\"></span>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t<div class=\"prdDetailWrap\">\r\n");
      out.write("\t\t\t\t<div class=\"prdImg\">\r\n");
      out.write("                    <img id=\"ctl00_Contents_imgMenu\" src=\"../boot/tkdvna_img/zhffhaqldk.jpg\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"prdSummary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"summInner\">\r\n");
      out.write("\t\t\t\t\t\t<strong class=\"detailTit\">과테말라 안티구아</strong>\r\n");
      out.write("\t\t\t\t\t\t<p class=\"menuTxt\">\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 콜롬비아 수프리모 -->\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<strong class=\"detailTit type02\">원두정보</strong>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"viewWrap type02\">\r\n");
      out.write("\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">향</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t★★☆☆☆\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">신맛</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t★☆☆☆☆\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">단맛</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t★★★★☆\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">쓴맛</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t★★★★☆\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">바디</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t★★★★★\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong class=\"cell_th\">추천포인트</strong>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cell_td\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t알맞은 산도와 달콤한 맛, 풍부한 바디(Body), 생동감 있는 아로마를 가짐\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
