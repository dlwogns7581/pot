			...
			<div class="productFinder_list">
				<div class="findWrap">
					<div class="find_frame">
					 <div class="pts" align="center">1. 누구와 마실 건가요?</div>
						<div class="find_section find_section1">

							<!-- <p class="find_con find_con01"  >1. 누구와 마실 건가요?</p> -->
							...
							<ul class="find_taste find_taste01">
								<li class="ft_t01">
									<dl style="opacity: 1; top: 0px;">
										<dt>
											<a href="Coffe2.jsp"><img src="../boot/1img/1.png" alt="Coffe2.jsp"></a>
										</dt>
										<dd>혼자 (조용한 카페)</dd>
									</dl>
								</li>
								<li class="ft_t02">
									<dl style="opacity: 1; top: 0px;">
										<dt>
										<a href="Coffe2.jsp"><img src="../boot/1img/2.png" alt="Coffe2.jsp"></a>
										</dt>
										<dd>친구 (활발한 분위기 카페)</dd>
									</dl>
								</li>
								...
								<li class="ft_t03">
									<dl style="opacity: 1; top: 0px;">
										<dt>
											<a href="Coffe2.jsp"><img src="../boot/1img/3.png" alt="Coffe2.jsp"></a>
										</dt>
										<dd>연인 (조용한 카페)</dd>
									</dl>
								</li>
								<li class="last ft_t04">
									<dl style="opacity: 1; top: 0px;">
										...
										<dt>
											<a href="Coffe2.jsp"><img src="../boot/1img/4.png" alt="Coffe2.jsp"></a>
										</dt>
										<dd>가족 (활발한 분위기 카페)</dd>
									</dl>
								</li>
