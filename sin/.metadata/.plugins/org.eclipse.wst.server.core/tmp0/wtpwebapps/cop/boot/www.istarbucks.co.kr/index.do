...
<link href="/common/css/style_dt.css?v=20180802" rel="stylesheet"> <!-- 20180413 �߰� -->
...
var eFrequencySeq = '154';
		...
		<link rel="shortcut icon" href="//image.istarbucks.co.kr/common/img/common/favicon.ico" type="image/ico" />
		<link href="/common/css/style_main.css?v=190103" rel="stylesheet" />
		<link href="/common/css/style_main_prom.css?v=161130" rel="stylesheet" />
		<link href="/common/css/style_main_19autumnProm1.css?v=190826" rel="stylesheet" /><!-- 20190826 추가 -->
		<!--[if lt IE 9]>
			...
			<div id="top_MSR" ><!-- 20170510 수정 : 클래스 eFreqTop 추가 -->
				<div class="top_msr_wrap" style="display:none;">
					...
					<div class="msr_lead">
						<a href="/msr/msreward/level_benefit.do">
							...
							<p class="msr_lead_txt"><strong>마이 스타벅스 리워드</strong><br>혜택에 편리함까지 더한<br>마이 스타벅스 리워드를<br>즐겨보세요.</p>
						</a>
					</div>
					<!-- 일반회원 end -->
					<!-- 유저레벨 end -->
				...
				<div class="top_msr_nologin">
					...
					<div class="top_msr_nologin_r">
						...
						<p class="sbcard_lead_txt"><strong>스타벅스 카드를 가지고 계신가요?</strong><br>스타벅스 카드를 등록하시면, 마이 스타벅스 리워드 만의<br>특별한 혜택을 누릴 수 있습니다.</p>
				...
				<div class="mob_gnb_wrap_inner">
					...
					<nav class="mob_gnb_menus">
						<ul>
							...
							<li><a href="javascript:void(0);"  required="expressdt" onclick="fn_moveDtAuth();">My DT Pass</a></li>
						...
						<ul>
							...
							<li><a href="/coffee/reserve_info.do">스타벅스 리저브™</a></li>
							<li>
						...
						<ul>
							...
							<li><a href="/store/store_food.do">프리미어 푸드 서비스 스토어</a></li>
							<li>
						...
						<ul>
							<li class="mob_gnb_ttl2"><a role="button" class="en" href="javascript:void(0);">MY STARBUCKS REWARDS<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 --></li>
							<li><a href="/msr/index.do">한눈에 보기</a></li>
							<li>
								<a role="button" href="javascript:void(0);">마이 스타벅스 리워드<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 -->
								<ul>
						...
						<ul>
							...
							<li>
								...
								<ul>
									...
									<li><a href="/whats_new/2019planner.do">2019 스타벅스 플래너</a></li>
								</ul>
							</li>
							<li>
...
<ul>
	...
	<li class="util_nav04"><a href="/store/store_map.do">Find a Store</a></li>
		...
		<!-- 서브 gnb end -->
			...
			<!-- s::20190826 main visual 수정-->
			<div id="topWrap">
				<div class="autumn1_mv_wrap">
					<div class="main_summer_bg"></div>
					<div class="main_19autumn1_inner">
						<div class="autumn19_maple"></div>
						<div class="autumn19_emblem">
							<span class="emblem_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn1_emblem.png" alt="fueled by heart"></span>
							<span class="emblem_m"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn1_emblem.png" alt="fueled by heart"></span>
						</div>
						<p class="btn_autumn19_detail">
							<a href="/whats_new/campaign_view.do?pro_seq=1614">자세히 보기</a>
						</p>
						<!-- s::set01 -->
						<div class="autumn19_set set_01">
							<div class="aut19_bev1_txt">
								<span class="aut19_txt_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn1_bev2_txt.png" alt="단호박 라떼 위드 샷"></span>
								<span class="aut19_txt_m"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn1_bev2_txt.png" alt="단호박 라떼 위드 샷"></span>
							</div>
							<div class="aut19_bev1_cup">
								<span class="aut19_cup_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn1_bev2_cup.png" alt="단호박 라떼 위드 샷"></span>
								<span class="aut19_cup_m"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn1_bev2_cup.png" alt="단호박 라떼 위드 샷"></span>
							</div> 
							<a href="/menu/drink_view.do?product_cd=9200000002373">단호박 라떼 위드 샷</a> 
						</div>
						<div class="set_link_01"><a href="/menu/drink_view.do?product_cd=9200000002373">단호박 라떼 위드 샷</a></div>
						<!-- e::set01 -->
						<!-- s::set02 -->
						<div class="autumn19_set set_02">
							<div class="aut19_bev1_txt">
								<span class="aut19_txt_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn1_bev1_txt.png" alt="블랙 글레이즈드 라떼"></span>
								<span class="aut19_txt_m"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn1_bev1_txt.png" alt="블랙 글레이즈드 라떼"></span>
							</div>
							<div class="aut19_bev1_cup">
								<span class="aut19_cup_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn1_bev1_cup.png" alt="블랙 글레이즈드 라떼"></span>
								<span class="aut19_cup_m"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn1_bev1_2_cup.png" alt="블랙 글레이즈드 라떼"></span>
							</div> 
							<a href="/menu/drink_view.do?product_cd=9200000002262">블랙 글레이즈드 라떼</a> 
						</div>
						<div class="set_link_02"><a href="/menu/drink_view.do?product_cd=9200000002262">블랙 글레이즈드 라떼</a> </div><!-- 20190827 추가 -->
						<!-- e::set02 -->
					</div>
					<!-- s::20190826 플로팅 뱃지 추가 -->
					<div class="layer_floating">
						<a href="/menu/product_list.do?TYPE=THEME"></a>
					</div>
					<!-- e::20190826 플로팅 뱃지 추가 -->
				</div>
			</div>
			<!-- //e::20190826 main visual 수정-->
				...
				<div class="line_notice_bg">
					<div class="line_notice_bgl">
						<div class="line_notice_inner">
							<dl class="line_notice_inner_l">
								<dt class="notice_ttl">
									<img src="//image.istarbucks.co.kr/common/img/common/notice_ttl.png" alt="공지사항">
								</dt>
								<dd>
					...
					<div class="line_notice_bgr">
						<a href="javascript:void(0);">
							...
							<span class="btn_prom"><img src="//image.istarbucks.co.kr/common/img/common/btn_prom_down.png" alt="스타벅스 프로모션 펼쳐보기" role="button" /><!-- 접근성_20171201 alt, role 추가 --></span><!-- 150818 성연욱 수정 -->
						</a>
					</div>
				</div>
			</section>
			...
			<!-- 프로모션 배너 end -->
			<!-- reward -->
			<section class="line_reward_wrap" style="display:none;">
				<div class="line_reward_wrap_l"></div>
				<div class="line_reward_wrap_r"></div>
				<section class="line_reward">
					<div class="line_reward_l">
						<div class="reward_star_bg"><img alt="" src="//image.istarbucks.co.kr/common/img/main/reward_logo.png"></div>
					</div>
					<div class="line_reward_r">
						<div class="reward_texbg">
							<img alt="스타벅스만의 특별한 혜택, 마이 스타벅스 리워드 스타벅스 회원이세요? 로그인을 통해 나만의 리워드를 확인해 보세요. 스타벅스 회원이 아니세요? 가입을 통해 리워드 혜택을 즐기세요." class="reward_txt" src="//image.istarbucks.co.kr/common/img/main/reward_txt.png">
							<img alt="스타벅스만의 특별한 혜택, 마이 스타벅스 리워드 스타벅스 회원이세요? 로그인을 통해 나만의 리워드를 확인해 보세요. 스타벅스 회원이 아니세요? 가입을 통해 리워드 혜택을 즐기세요." class="tablet_reward_txt" src="//image.istarbucks.co.kr/common/img/main/tablet_reward_txt.png">
						</div>
						<div class="reward_btn">
							<ul>
								<li class="reward_memjoin"><a href="/mem/join.do">회원가입</a></li>
								<li class="reward_login"><a href="javascript:$.loginLib.showLayerLogin();">로그인</a></li>
							</ul>
						</div>
						<!-- 20181205 alt값 수정, 이미지 교체 -->
						<div class="reward_egift">
							<img alt="카드를 등록하여 마이 스타벅스 리워드 회원이 되신 후, 첫 구매를 하시면 무료 음료 쿠폰을 드립니다!" class="egift_txt" src="//image.istarbucks.co.kr/common/img/main/egiftCard_txt.png">
							<img alt="카드를 등록하여 마이 스타벅스 리워드 회원이 되신 후, 첫 구매를 하시면 무료 음료 쿠폰을 드립니다!" class="tablet_egift_txt" src="//image.istarbucks.co.kr/common/img/main/tablet_egiftCard_txt.png">
						</div>
						<!-- //20181205 alt값 수정, 이미지 교체 -->
						<div class="reward_egift_btn">
							<ul>
								<li><a href="/msr/sceGift/gift_step1.do">e-Gift Card 선물하기</a></li>
							</ul>
						</div>
					</div>
				</section>
			...
			<div class="line_msr" style="display:none;">
				<div class="line_msr_wrap">
					...
					<div class="user_greet">
						...
						<p class="user_greet_txt"><strong><!-- 스벅매니아 --></strong>님, 안녕하세요!</p>
						<p class="msr_btn_setting"><a href="/my/myinfo_modify_login.do" required="login">개인정보 수정</a></p>
					</div>
					<!-- 유저인포 end -->
					...
					<div class="user_level">
						<a href="/my/reward.do" title="마이 리워드"><!-- 접근성_20171106 title 추가 -->
							<p class="level_star_bg en">0</p>
					...
					<div class="msr_card_zone m_card_pic">
						...
						<div class="mycard_one">
							<!-- <div class="front"> -->
							<!-- <img src="//image.istarbucks.co.kr/common/img/common/payment_icon1.png" alt=""> -->
							<img src="//image.istarbucks.co.kr/common/img/common/payment_icon1.png" alt="결제하기"><!-- 접근성_20171106 alt 추가 -->
							<!-- </div> -->
							<!-- <div class="back"><img src="//image.istarbucks.co.kr/common/img/common/payment_icon1.png" alt=""></div> -->
						</div>						
						<p class="mycard_money_result">잔액 <span class="en balance"><!-- 550,000 --></span>원</p>
					...
					<div class="sb_card_regi">
						...
						<p class="icon_add_card" onclick="location.href = '/my/mycard_info_input.do';"><img alt="카드등록 아이콘" src="//image.istarbucks.co.kr/common/img/common/icon_add_card.png"></p>
						<p class="sb_card_regi_txt" style="display:none;"><strong>스타벅스 카드 등록</strong><br>카드를 등록하시고<br>다양한 리워드를<br>만나보세요.</p>
						<!-- 등록된 카드가 없는 경우 -->
			...
			<!-- 17summer1 bean 20170720 영역 삭제 -- >
			<section id="summer17_img">
				<div class="wrap_inner">
					<div class="bean_icon01"></div>
					<div class="bean_icon02"></div>
					<div class="bean_icon03"></div>
				</div>
			</section>
			<!-- 17summer1 bean end -->
			
			<!-- 20190826 main Bean 수정-->
			 <section id="autumn19_beanWrap">
                <div class="bean_wrap_inner">
                    <div class="winter_bean_wrap">
						<div class="winter19_bean">
							<span class="bean_img_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn1_bean.png" alt="애니버서리 블렌드" /></span>
							<span class="bean_img_m"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn1_bean.png" alt="애니버서리 블렌드" /></span>
						</div>
						<!-- text 영역 -->
						<div class="bean_right">
							<div class="bean_area">
								<div class="winter19_bean_ttl">
									<span class="bean_ttl_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn1_bean_ttl.png" alt="가을을 더욱 풍성하게 만들어 줄 시즌 원두 애니버서리 블렌드" /></span>
									<span class="bean_ttl_m"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn1_bean_ttl.png" alt="가을을 더욱 풍성하게 만들어 줄 시즌 원두 애니버서리 블렌드" /></span>
								</div>
								<div class="winter19_bean_txt">
									<span class="bean_txt_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn1_bean_txt.png" alt="숙성 수마트라 원두가 가진 특유의 부드러움과 삼나무의 스파이시 풍미가 어우러져 풍부하고 매력적인 풍미를 느낄 수 있는 커피입니다." /></span>
									<span class="bean_txt_m"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn1_bean_txt.png" alt="숙성 수마트라 원두가 가진 특유의 부드러움과 삼나무의 스파이시 풍미가 어우러져 풍부하고 매력적인 풍미를 느낄 수 있는 커피입니다." /></span>
								</div>
								<div class="btn_winter19_bean"><a href="/coffee/product_view.do?PRODUCT_CD=250034">자세히 보기</a></div> 		
							</div>
						</div>
						<!-- //text 영역 -->
                    </div>
			...
			<!-- s::20190820 리저브 수정 -->
			<section id="blackReserveWrap_nw">
				<div class="wrap_inner new_19autumn_reserve">
					<div class="black_reserve_logo_new">
						<span class="rs_logo_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn_reserve_coffee_logo.png" alt="리저브 로고" /></span>
						<span class="rs_logo_mo"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn_reserve_coffee_logo.png" alt="리저브 로고" /></span>
					</div>
					<div class="black_reserve_txt_area">
						<span class="re_txt_pc"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/19_autumn_reserve_txt1.png" alt="쥬시하고 달콤한 레드 커런트와 은은한 캐러멜의 풍미가 매력적인 콜롬비아 엘 터널 베르데를 소개합니다." /></span>
						<span class="re_txt_mo"><img src="//image.istarbucks.co.kr/upload/common/img/main/2019/m_19_autumn_reserve_txt1.png" alt="쥬시하고 달콤한 레드 커런트와 은은한 캐러멜의 풍미가 매력적인 콜롬비아 엘 터널 베르데를 소개합니다." /></span>
						<div class="black_btn_sum19 btnSpPc"><a href="/whats_new/newsView.do?seq=3597">자세히 보기</a></div>
					</div>
					<div class="res_bean_17spring2"></div>
					<div class="black_btn_sum19 btnSpMo"><a href="/whats_new/newsView.do?seq=3597">자세히 보기</a></div>
				</div>
			</section>
			<!-- e::20190820 리저브 수정 -->

			<!-- s::20190207 19spring favorite -->
			<section id="favWrap" class="winter_fav_bg">
				<div class="wrap_inner">
					...
					<div class="summer_17_fav_img autumn19Fav"></div><!-- 20190826 class="autumn19Fav" 수정 -->
					<div class="btn_fav_prod"><a href="/menu/index.do">자세히 보기</a></div>
				</div>
			</section>
			<!-- e::20190207 19spring favorite -->
			...
			<section id="reserve2Wrap">
				<div id="reserve2_medal">
					...
					<div class="reserve2_medal02 back">
						...
						<a href="http://www.istarbucks.co.kr/store/store_reserve.do">매장보기</a>
					</div>
				</div>
			</section>
			<!-- 리저브매장 end -->
			 ...
			 <!--section id="driveWrap">
				<div id="drive_medal">
					...
					<div class="drive_medal02 back">
						<a href="http://www.istarbucks.co.kr/store/store_drive.do">매장보기</a>
					</div>
				</div>
			</section--> 
			<!-- 드라이브 김민호 추가 end -->
			...
			<footer id="footer">
				...
				<div class="dtPop ecoPop" id="msrCheckPop_rewardTumbler" style="display:none">
					<div class="head">
						<p class="tt">마이 스타벅스 리워드 등록 안내</p>
				...
				<aside class="copyright">
					...
					<a href="/footer/etc/hotline.do" class="last">윤리경영 핫라인</a></span><br>
					...
					<ul class="copy_menu">
						...
						<li>개인정보 책임자 : 양종환</li><!-- 20190806 수정 -->
					</ul>
			...
			<script src="//image.istarbucks.co.kr/common/js/common.js"></script>
			<script src="/common/js/gnb.js?v=190723"></script>
			<script src="//image.istarbucks.co.kr/common/js/header.js"></script>
...
// 					console.log($('.ms_sub_tit_bg .en').text());
// 					console.log($('.ms_sub_tit_bg .kor').text());
//  				console.log($('.smap li').last().text());
// 					console.log($('.smap .kor').text());
// 					console.log($('.smap').find('.en').length);
// 					console.log($('.smap').find('.kor').length);
...
// 					});
                    ...
                    $("#expressDt").click(function(){
                          /** 세션 종료 체크 */ 
                        var url = location.pathname;
                    	fn_showPassLayer(url);
                    });
                ...
                function edtPwdCheck(){ 
                	...
                	$('#commonPop').fadeOut();
                     ...
                     }else if ($("#dtsPwdchk").val() == "C"){
                         location.href = "/edt/expressDtList.do";
                         /* security review결과로 인해 비밀번호 확인 로직 제거 */

                     }
                }
                
                function fn_moveDtAuth(){
                	fn_hideGnbMenu();
                	var url = document.location.pathname;
                	fn_showPassLayer(url);
                }
                
                function fn_showPassLayer(url){
                	/** 세션 종료 체크 */
                    $.ajax({
                    	type: 'post',
                    	url : m_domain_ssl + '/edt/edtCheckLogin.do',
                    	data : {},
                    	dataType : 'jsonp',
                    	jsonp : 'callback',
                    	success : function(_response){
                    		...
                    		if(_response.result_code != "SUCCESS"){
                    			...
                    			if (m_jsonRewardSummary == null) {
                    				 $.ajax({
                                     	type: 'post',
                                     	url : m_domain_ssl + '/interface/getMsrRewardSummary.do',
                                     	data : {},
                                     	dataType : 'jsonp',
                                     	jsonp : 'callback',
                                     	async : false,
                                     	success : function(_response){
                                     		if (_response.result_code == "SUCCESS") {
												...
												fn_edtEnterCheck(m_jsonRewardSummary);
											}
                                     	}
                                   	});
								}else{
                ...
                function fn_edtEnterCheck(obj){
                	  if( obj.msrMemberYn == "Y"){
                          $("#dtsPwdchk").val("C"); 
                          edtPwdCheck();
                      }else{
                          $('#msrCheckPop').fadeIn();
                          $('.dt_pop_up_dimm').fadeIn();
                          $('.dtPopInner').css({"display":"none"});
                          $("#Msr").css({'display':'block'});
                          $('.dtPopBtn2').hide();
                          $('#dtPopPwdCheckBtnMsr').unbind('click');
                          $('#dtPopPwdCheckBtnMsr').on('click', function(){
                          	edtPwdCheck();	
                          });
                          $('#dtPopPwdCheckBtnMsr, #dtPopCancelBtn').show();
                          $('div.dtPop > div.head > p.tt').text("마이 스타벅스 리워드 등록 안내");
                          $("#dtsPwdchk2").val("F");
                      }
                }
                /* 개인컵 리워드 s */
			...
			<script src="/common/js/main_ani.js"></script>
			<script src="/common/js/main_prom.js"></script>
			<!--script src="/common/js/main_prom3.js"></script--> <!-- 20170831 삭제 -->
			<script src="/common/js/main_teavana.js?v=190826"></script> <!-- 20190826 수정 -->
