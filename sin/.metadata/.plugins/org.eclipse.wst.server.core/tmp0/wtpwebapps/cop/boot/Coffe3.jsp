			...
			<div class="productFinder_list">
				<div class="findWrap">
					<div class="find_frame">
					 <div class="pts" align="center">3. 카페에서 할 일이 있으세요?</div>
							...
							<ul class="find_taste find_taste01">
								...
								<li class="ft_t02">
									<dl style="opacity: 1; top: 0px;">
										<dt>
											<a href="Coffe4.jsp"
												onclick="document.frm.COFFEE_TASTE1.value = 20;"><img
												src="../boot/3img/1.png" alt="Coffe4.jsp"></a>
										</dt>
										<dd>공부나 일 (조용한 카페)</dd>
									</dl>
								</li>
								...
								<li class="last ft_t04">
									<dl style="opacity: 1; top: 0px;">
										<dt>
											<a href="Coffe4.jsp"
												onclick="document.frm.COFFEE_TASTE1.value = 40;"><img
												src="../boot/3img/2.png" alt="Coffe4.jsp"></a>
										</dt>
										<dd>이야기 (활발한 분위기 카페)</dd>
									</dl>
								</li>
							</ul>
						</div>
