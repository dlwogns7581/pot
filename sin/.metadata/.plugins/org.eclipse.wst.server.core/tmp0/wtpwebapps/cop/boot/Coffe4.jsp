			...
			<div class="productFinder_list">
				<div class="findWrap">
					<div class="find_frame">
					 <div class="pts" align="center">4. 어떤 맛의 음료를 원하세요?</div>
							...
							<ul class="find_taste find_taste01">
								<li class="ft_t01">
									<dl style="opacity: 1; top: 0px;">
										<dt>
											<a href="rufrhk1.jsp"><img src="../boot/4img/1.png" alt="rufrhk1.jsp"></a>
										</dt>
										<dd>짭짤한맛</dd>
									</dl>
								</li>
								<li class="ft_t02">
									<dl style="opacity: 1; top: 0px;">
										<dt>
										<a href="rufrhk2.jsp"><img src="../boot/4img/2.png" alt="Coffe1_1.jsp"></a>
										</dt>
										<dd>과일맛</dd>
									</dl>
								</li>
								...
								<li class="ft_t03">
									<dl style="opacity: 1; top: 0px;">
										<dt>
											<a href="rufrhk3.jsp"><img src="../boot/4img/3.png" alt="Coffe1_1.jsp"></a>
										</dt>
										<dd>구운맛</dd>
									</dl>
								</li>
								<li class="last ft_t04">
									<dl style="opacity: 1; top: 0px;">
										...
										<dt>
											<a href="rufrhk4.jsp"><img src="../boot/4img/4.png" alt="Coffe1_1.jsp"></a>
										</dt>
										<dd>달콤한 맛 (캐러멜)</dd>
									</dl>
								</li>
